...
export const ImageUpload = () => {
  ...
  useEffect(() => {
    ...
    return () => URL.revokeObjectURL(objectUrl); // Clean up object URL on component unmount
  }, [selectedFile]);

  // This effect sends the file when the preview is updated
  useEffect(() => {
    if (preview) {
      sendFile();
    }
  }, [preview, sendFile]); // Include sendFile in the dependencies array
